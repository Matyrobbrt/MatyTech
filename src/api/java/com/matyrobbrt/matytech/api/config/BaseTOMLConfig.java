package com.matyrobbrt.matytech.api.config;
...
public abstract class BaseTOMLConfig {
	...
	public static <T> ConfigValue<T> config(String comment, String path, T defaultValue, boolean addDefaultValueComment,
			Builder builder) {
